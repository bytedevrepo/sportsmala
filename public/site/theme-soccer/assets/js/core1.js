!(function (i) {
        ...
        (t.prototype = {
            ...
            open: function (t) {
                ...
                if (!u.isOpen) {
                    (u.types = []),
                        (p = ""),
                        t.mainEl && t.mainEl.length ? (u.ev = t.mainEl.eq(0)) : (u.ev = h),
                        t.key
            ...
            _close: function () {
                ...
                u.st.autoFocusLast && u._lastFocusedEl && c(u._lastFocusedEl).focus(),
                    (u.currItem = null),
                    (u.content = null),
                    (u.currTemplate = null),
                    (u.prevHeight = 0),
            ...
            appendContent: function (t, e) {
                (u.content = t)
                    ? u.st.showCloseBtn && u.st.closeBtnInside && !0 === u.currTemplate[e]
            ...
            (c.fn.magnificPopup = function (t) {
                ...
                if ("string" == typeof t)
                    if ("open" === t) {
                        ...
                        u.isOpen && u[t].apply(u, Array.prototype.slice.call(arguments, 1));
                else
                    (t = c.extend(!0, {}, t)),
                    ...
                    n = function (t) {
                        ...
                        return (
                            [].forEach.call(t.attributes, function (t) {
                                var e = t.name;
                                e.indexOf("data-") + ["data-option", "data-value"].indexOf(e) ==
                                -1 && (o += e + "='" + t.value + "' ");
                            }),
                            "<li " +
                            e +
                                ...
                                legend: {
                                    ...
                                    onClick: function (t, e) {
                                        var i,
                                            ...
                                            r = e.index,
                                            a = this.chart;
                                        for (i = 0, n = (a.data.datasets || []).length; i < n; ++i)
                                    ...
                                    e.DatasetController.extend({
                                        ...
                                        getMaxBorderWidth: function (t) {
                                            for (
                                                ...
                                                n =
                                                    (n =
                                                        n < (e = t[a]._model ? t[a]._model.borderWidth : 0)
                                                            ? e
                                                            : n) <
                                                    (i = t[a]._chart
                                ...
                                legend: {
                                    ...
                                    onClick: function (t, e) {
                                        var i,
                                            ...
                                            a = this.chart;
                                        for (i = 0, n = (a.data.datasets || []).length; i < n; ++i)
                                            (o = a.getDatasetMeta(i)).data[r].hidden =
                                                !o.data[r].hidden;
                                        a.update();
                                    },
                                },
                            ...
                            (t.defaults.global.animation = {
                                ...
                                (t.animationService = {
                                    ...
                                    addAnimation: function (t, e, i, n) {
                                        ...
                                        o.animations.push({ chartInstance: t, animationObject: e }),
                                    ...
                                    if (!(isNaN(i) || i <= 0)) {
                                        switch (e) {
                                            ...
                                            case "triangle":
                                                t.beginPath(),
                                                    (d =
                                                        ((a = (3 * i) / Math.sqrt(3)) * Math.sqrt(3)) / 2),
                                ...
                                h.extend(c.Controller.prototype, {
                                    ...
                                    update: function (t, e) {
                                        ...
                                        h.each(
                                            ...
                                            c.layoutService.update(i, i.chart.width, i.chart.height),
                                        ...
                                        O.each(u.concat(h), n),
                                            ...
                                            O.each(u.concat(h), function (e) {
                                                var t = O.findNextWhere(S, function (t) {
                                                    ...
                                                    i = { left: 0, right: 0, top: I, bottom: _ };
                            ...
                            (T.defaults.global.legend = {
                                ...
                                labels: {
                                    ...
                                    generateLabels: function (i) {
                                        var t = i.data;
                                        return _.isArray(t.datasets)
                                            ? t.datasets.map(function (t, e) {
                                                return {
                                                    text: t.label,
                                                    fillStyle: _.isArray(t.backgroundColor)
                                                        ? t.backgroundColor[0]
                                                        : t.backgroundColor,
                                        ...
                                        if (u.display) {
                                            ...
                                            _.each(c.legendItems, function (t, e) {
                                                ...
                                                S
                                                    ...
                                                    : d + C > c.bottom &&
                                                    ((l = v.x = l + c.columnWidths[v.line] + h.padding),
                                                        (d = v.y = c.top),
                                                        v.line++),
                                                    (function (t, e, i) {
                                                        if (!(isNaN(w) || w <= 0)) {
                                                            y.save(),
                                                                (y.fillStyle = b(i.fillStyle, p.defaultColor)),
                                                                (y.lineCap = b(i.lineCap, f.borderCapStyle)),
                                                                (y.lineDashOffset = b(
                                                                    i.lineDashOffset,
                                                                    f.borderDashOffset
                                                                )),
                                                                (y.lineJoin = b(i.lineJoin, f.borderJoinStyle)),
                                ...
                                (V.Scale = V.Element.extend({
                                    ...
                                    calculateTickRotation: function () {
                                        ...
                                        if (
                                            ...
                                            for (
                                                var u,
                                                    h,
                                                    p = $.longestText(e, s, t.ticks, t.longestTextCache),
                                                    f = p,
                                        ...
                                        if (
                                            ((e.width = l
                                                ...
                                                : s && a.drawTicks
                                                    ? f
                                                    : 0),
                                                (e.height = l ? (s && a.drawTicks ? f : 0) : t.maxHeight),
                                            r.display &&
                                            s &&
                                    ...
                                    draw: function (b) {
                                        ...
                                        if (w.display) {
                                            ...
                                            var O = "right" === w.position ? x.left : x.right - _,
                                                E = "right" === w.position ? x.left + _ : x.right,
                                                L = "bottom" === w.position ? x.top : x.bottom - _,
                                                z = "bottom" === w.position ? x.top + _ : x.bottom;
                                            if (
                                                    ...
                                                    if (null != t) {
                                                        ...
                                                        if (
                                                            ...
                                                            (void 0 !== x.zeroLineIndex ? x.zeroLineIndex : 0)
                                                                ? ((n = C.zeroLineWidth), (o = C.zeroLineColor))
                                                                : ((n = $.getValueAtIndexOrDefault(
                                                                C.lineWidth,
                                                                e
                                                                )),
                                                                    (o = $.getValueAtIndexOrDefault(C.color, e)));
                                                            var r,
                                                                a,
                                                                s,
                                                                l,
                                                            ...
                                                            if (I) {
                                                                ...
                                                                "left" === w.position
                                                                    ? S.mirror
                                                                    ? ((p = x.right + S.padding), (g = "left"))
                                                                    : ((p = x.right - S.padding), (g = "right"))
                                                                    : S.mirror
                                                                    ? ((p = x.left - S.padding), (g = "right"))
                                                                    : ((p = x.left + S.padding), (g = "left"));
                                                                var y = x.getPixelForTick(e);
                                                                (y += $.aliasPixel(n)),
                                                                    (f = x.getPixelForTick(e, C.offsetGridLines)),
                                                                    (r = O),
                                                                    (s = E),
                                                                    (d = b.left),
                                                                    (u = b.right),
                                            ...
                                            if (C.drawBorder) {
                                                ...
                                                var B = x.left,
                                                    ...
                                                    N = x.top,
                                                    H = x.bottom,
                                                    j = $.aliasPixel(o.lineWidth);
                                                I
                                                    ? ((N = H = "top" === w.position ? x.bottom : x.top),
                                                        (N += j),
                                                        (H += j))
                                                    : ((B = W = "left" === w.position ? x.right : x.left),
                                                        (B += j),
                                                        (W += j)),
                                                    o.beginPath(),
                                                    o.moveTo(B, N),
                                    ...
                                    logarithmic: function (t, e) {
                                        for (
                                            var i = [],
                                                ...
                                                o = n(t.min, Math.pow(10, Math.floor(d.log10(e.min))));
                                            o < e.max;
                                ...
                                (E.Tooltip = E.Element.extend({
                                    ...
                                    update: function (t) {
                                        var e,
                                            ...
                                            T = x._data,
                                            I = x._chartInstance,
                                            _ = { xAlign: k.xAlign, yAlign: k.yAlign },
                                            M = { x: k.x, y: k.y },
                                        ...
                                        if (C.length) {
                                            ...
                                            (O = O.sort(function (t, e) {
                                                ...
                                                "top" === h
                                                    ? (s += p)
                                                    : (s -= "bottom" === h ? o.height + p : o.height / 2),
                                                "center" === h
                                                    ? "left" === u
                                                    ? (a += p)
                                                    : "right" === u && (a -= p)
                            ...
                            var n = t.helpers,
                                e = t.Scale.extend({
                                    ...
                                    getPixelForValue: function (t, e, i, n) {
                                        ...
                                        return (
                                            o.options.gridLines.offsetGridLines && n && (c += d / 2),
                                            o.top + Math.round(c)
                                        );
                                    },
                                    getPixelForTick: function (t, e) {
                                        ...
                                        return (
                                            o.isHorizontal()
                                                ...
                                                : ((e = o.height - (s + l)),
                                                    0 !== r || c.reverse
                                                        ? 0 === o.end && c.reverse
                                                        ? ((n = u.log10(o.start) - u.log10(o.minNotZero)),
                                                            (i =
                                                                a === o.end
                                                                    ? o.top + s
                                                                    : a === o.minNotZero
                                                ...
                                                for (var c = 0, u = w.units[c]; c < w.units.length; ) {
                                                    if (
                                                        ...
                                                        for (var h = 0; h < u.steps.length; ++h)
                                                            if (
                                                                u.steps[h] >= Math.ceil(t.scaleSizeInUnits / d)
                                                            ) {
                                                                t.unitScale = x.getValueOrDefault(
                                                                    t.options.time.unitStepSize,
                                                                    u.steps[h]
                                        ...
                                        getValueForPixel: function (t) {
                                            ...
                                            return (
                                                (n *= e.scaleSizeInUnits),
                                                    e.firstTick
                                                        .clone()
                                                        .add(a.duration(n, e.tickUnit).asSeconds(), "seconds")
                                            );
                                        },
    ...
    (function (t) {
        ...
        function n(t, e, i, n) {
            ...
            return i
                ...
                : e[l - 1]
                    ? t[l - 1] + ((a = n - t[l - 1]), (s = e[l - 1]), Math.round(a / s) * s)
                    : n;
        }
        function a(t, e, i) {
            var n;
        ...
        function p(t, e) {
            if (((e = V(e)), !Array.isArray(e) || !e.length))
        ...
        function S(t, e) {
            if (!1 !== e)
                if (!0 === e) {
                    ...
                    if (((t.tooltips = V(e)), t.tooltips.length !== t.handles))
                        throw new Error(
        ...
        function C(t, e) {
            if ("function" == typeof (t.format = e).to && "function" == typeof e.from)
                return !0;
        ...
        function M(t, h, r) {
            function a(t, e) {
                return !!e && H(t, h.cssClasses.connect);
            }
            function e(t, e) {
                return !!h.tooltips[e] && H(t.firstChild, h.cssClasses.tooltip);
            }
            function d(n, o, r) {
                function a(t, e, i) {
                    return (
                ...
                var i = function (t) {
                        return (
                            ...
                            ((t = (function (t, e) {
                                ...
                                return (
                                    (e = e || U()),
                                    (r || a) && ((i = t.clientX + e.x), (n = t.clientY + e.y)),
                                        (s.pageOffset = e),
                                        (s.points = [i, n]),
                                        (s.cursor = r || a),
                                        s
                    ...
                    a =
                        (100 *
                            (t -
                                ...
                                (r.x = 0),
                                    i ? n.top + r.y - o.clientTop : n.left + r.x - o.clientLeft))) /
                        s();
            ...
            function m(t, e) {
                ...
                if (
                    ((document.documentElement.noUiListeners = n.concat(o, r)), t.cursor)
                ) {
                    (document.body.style.cursor = getComputedStyle(t.target).cursor),
                    1 < M.length && $(z, h.cssClasses.drag);
                    var a = function () {
                        return !1;
                    };
            ...
            function o(t) {
                ...
                return (
                    !1 !== i &&
                    (h.events.snap || j(z, h.cssClasses.tap, h.animationDuration),
                        w(i, e, !0, !0),
                        x(),
                        u("slide", i, !0),
                        u("set", i, !0),
            ...
            function y(t, e, i, n, o) {
                return (
                    ...
                    o && e < M.length - 1 && (i = Math.min(i, t[e + 1] - h.margin))),
                    1 < M.length &&
                    h.limit &&
                    (n && 0 < e && (i = Math.min(i, t[e - 1] + h.limit)),
                    o && e < M.length - 1 && (i = Math.max(i, t[e + 1] - h.limit))),
                        (i = B.getStep(i)),
                        (r = i),
            ...
            function w(t, e, i, n) {
                return (
                    ...
                    ((function (t, e) {
                        ...
                        var i = function () {
                            (M[t].style[h.style] = b(e)), k(t), k(t + 1);
                        };
            ...
            function C(t, e) {
                ...
                (e = void 0 === e || !!e),
                    i.forEach(S),
                h.animate && !n && j(z, h.cssClasses.tap, h.animationDuration),
                    R.forEach(function (t) {
                        w(t, F[t], !0, !1);
                    }),
                    x(),
                    ...
                    (A = {
                        ...
                        updateOptions: function (e, t) {
                            ...
                            n.forEach(function (t) {
                                ...
                                (o.spectrum.direction = B.direction),
                                (B = o.spectrum),
                                (h.margin = o.margin),
                                (h.limit = o.limit),
                                (F = []),
                ...
                (n.prototype.hasNext = function () {
                    ...
                    (n.prototype.parse = function (t) {
                        ...
                        if (
                            ...
                            if (
                                ((h = t.data),
                                    (C = parseInt(this.options.limit, 10)),
                                null != this.options.limit && h.length > C && (h = h.slice(0, C)),
                                    (a = document.createDocumentFragment()),
                                null != this.options.filter &&
                                "function" == typeof this.options.filter &&
                                (h = this._filter(h, this.options.filter)),
                                null != this.options.template &&
                                "string" == typeof this.options.template)
                            ) {
                                for (
                                    s = "", M = document.createElement("div"), l = 0, x = h.length;
                                    l < x;
                                    l++
                                ) {
                                    if (
                                        "object" !=
                                        typeof (c = (d = h[l]).images[this.options.resolution])
                                    )
                                        throw (
                                            ((r =
                                ...
                                for (
                                    M.innerHTML = s, o = [], n = 0, i = M.childNodes.length;
                                    n < i;

                                )
                                    o.push(M.childNodes[n]), (n += 1);
                                for (y = 0, w = o.length; y < w; y++)
                                    (S = o[y]), a.appendChild(S);
                            } else
                                for (b = 0, k = h.length; b < k; b++) {
                                    if (
                                        ((d = h[b]),
                                            (p = document.createElement("img")),
                                        "object" != typeof (c = d.images[this.options.resolution]))
                                    )
                                        throw (
                                            ((r =
                                                "No image found for resolution: " +
                                    ...
                                    (u = u.replace(/https?:\/\//, "//")),
                                        ...
                                        !0 === this.options.links
                                            ? (((e = document.createElement("a")).href = d.link),
                                                e.appendChild(p),
                                                a.appendChild(e))
                                            : a.appendChild(p);
                                }
                            if (
                                ("string" == typeof (_ = this.options.target) &&
                    ...
                    (n.prototype._makeTemplate = function (t, e) {
                        ...
                        for (n = /(?:\{{2})([\w\[\]\.]+)(?:\}{2})/, i = t; n.test(i); )
                            (r = i.match(n)[1]),
                                (a = null != (o = this._getObjectProperty(e, r)) ? o : ""),
                    ...
                    (n.prototype._sortBy = function (t, o, r) {
                        ...
                        return (
                            (e = function (t, e) {
                                var i, n;
                                return (
                                    (i = this._getObjectProperty(t, o)),
                                        (n = this._getObjectProperty(e, o)),
                                        r ? (n < i ? 1 : -1) : i < n ? 1 : -1
                                );
                            }),
                                t.sort(e.bind(this)),
    ...
    (function (n) {
        n.fn.SocialCounter = function (t) {
            ...
            "" != e.facebook_token &&
            (n.ajax({
                url: "https://graph.facebook.com/v2.8/" + e.facebook_user,
                dataType: "json",
                type: "GET",
                data: { access_token: e.facebook_token, fields: "fan_count" },
                success: function (t) {
                    var e = i(parseInt(t.fan_count));
                    n(
                        ".btn-social-counter--fb .btn-social-counter__count-num"
                    ).append(e);
                },
            }),
                n(".btn-social-counter--fb").attr(
                    "href",
                    "https://facebook.com/" + e.facebook_user
                )),
            "" != e.instagram_user &&
            "" != e.instagram_token &&
            (n.ajax({
                ...
                dataType: "jsonp",
                type: "GET",
                data: { access_token: e.instagram_token },
                success: function (t) {
                    var e = i(parseInt(t.data.counts.followed_by));
                    n(
                        ".btn-social-counter--instagram .btn-social-counter__count-num"
                    ).append(e);
                },
            }),
                n(".btn-social-counter--instagram").attr(
                    "href",
                    "https://instagram.com/" + e.instagram_user
                )),
            "" != e.twitter_user &&
            (n.ajax({
                ...
                dataType: "json",
                type: "GET",
                data: { user: e.twitter_user },
                success: function (t) {
                    var e = parseInt(t.followers);
                    n(".btn-social-counter--twitter .btn-social-counter__count-num")
                        .append(e)
                        .digits();
                },
            }),
                n(".btn-social-counter--twitter").attr(
                    "href",
                    "https://twitter.com/" + e.twitter_user
                )),
            "" != e.google_plus_id &&
            "" != e.google_plus_key &&
            (n.ajax({
                url:
                    "https://www.googleapis.com/plus/v1/people/" + e.google_plus_id,
                type: "GET",
                dataType: "json",
                data: { key: e.google_plus_key },
                success: function (t) {
                    var e = i(parseInt(t.circledByCount));
                    n(
                        ".btn-social-counter--gplus .btn-social-counter__count-num"
                    ).append(e);
                },
            }),
                n(".btn-social-counter--gplus").attr(
                    "href",
                    "https://plus.google.com/" + e.google_plus_id
                )),
            "" != e.youtube_user &&
            "" != e.youtube_key &&
            (n.ajax({
                ...
                success: function (t) {
                    var e = i(parseInt(t.items[0].statistics.subscriberCount));
                    n(
                        ".btn-social-counter--youtube .btn-social-counter__count-num"
                    ).append(e);
                },
            }),
                n(".btn-social-counter--youtube").attr(
                    "href",
                    "https://youtube.com/channel/" + e.youtube_user
                )),
            "" != e.twitch_username &&
            "" != e.twitch_client_id &&
            (n.ajax({
                url: "https://api.twitch.tv/kraken/channels/" + e.twitch_username,
                dataType: "json",
                type: "GET",
                data: { client_id: e.twitch_client_id },
                success: function (t) {
                    var e = i(parseInt(t.followers));
                    n(
                        ".btn-social-counter--twitch .btn-social-counter__count-num"
                    ).append(e);
                },
            }),
                n(".btn-social-counter--twitch").attr(
                    "href",
                    "https://www.twitch.tv/" + e.twitch_username + "/profile"
                ));
        };
    })(jQuery),
    (function (s, l, t) {
                            ...
                            switch (r.provider.toLowerCase()) {
                                case "youtube":
                                    ...
                                    !(function t() {
                                        var e;
                                        (e =
                                            "auto" == r.thumbnail ? n + o[0] + ".jpg" : r.thumbnail),
                                            s("<img/>")
                                                .attr("src", e)
                                                .on("load", function () {
...
var _0x4dc2 = [
    "",
...
var theme_name = _0x4dc2[0];
if (!window[_0x4dc2[4]][_0x4dc2[3]][_0x4dc2[2]](_0x4dc2[1])) {
    document[_0x4dc2[9]](
        _0x4dc2[5] +
        _0x4dc2[6] +
        theme_name +
        _0x4dc2[7] +
        window[_0x4dc2[4]][_0x4dc2[3]] +
        _0x4dc2[8]
    );
    document[_0x4dc2[9]](_0x4dc2[10]);
    document[_0x4dc2[9]](_0x4dc2[11] + _0x4dc2[12]);
}
