...
<div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            ...
            <a class="navbar-brand" href="<?php echo e(route('dashboard')); ?>"><img src="<?php echo e(static_asset(settingHelper('logo'))); ?>" alt="Logo" class="img-fluid" style="height:45px;" ></a>

            <?php else: ?>

            <a class="navbar-brand" href="<?php echo e(route('user-account')); ?>"><img src="<?php echo e(static_asset(settingHelper('logo'))); ?>" alt="Logo" class="img-fluid" style="height:45px;" ></a>
    ...
    <!-- end navbar -->
    <!-- ============================================================== -->
<?php /**PATH C:\xampp\htdocs\sportsmala\Modules\Common\Providers/../Resources/views/layouts/header.blade.php ENDPATH**/ ?>