                        ...
                        <div class="col-12 col-lg-7">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="add-new-page  bg-white p-20 m-b-20">
                                        <div class="block-header m-b-20">
                                            <h2><?php echo e(__('Top News Section')); ?></h2>
                                        </div>
                                        <?php echo Form::open(['route'=>'update-top-news-section','method' => 'post']); ?>

                                        <div class="row p-l-15">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="no_of_posts" class="col-form-label"><?php echo e(__('Number of posts')); ?></label>
                                                    <input id="no_of_posts" name="posts_count" type="number" value="<?php echo e($topNewsSection->post_amount ?? 3); ?>" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-12">
                                                <div class="form-group">
                                                    <label for="no_of_posts" class="col-form-label"><?php echo e(__('Display style')); ?></label>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4">
                                ...
                                <div class="col-md-12">
                                    <div class="add-new-page  bg-white p-20 m-b-20">
                                        <div class="block-header m-b-20">
                                            <h2><?php echo e(__('Breaking News Section')); ?></h2>
                                        </div>
                                        <?php echo Form::open(['route'=>'update-breaking-section','method' => 'post']); ?>
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sportsmala\Modules\Appearance\Providers/../Resources/views/theme_section.blade.php ENDPATH**/ ?>