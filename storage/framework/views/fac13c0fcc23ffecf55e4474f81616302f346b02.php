    ...
    <div class="footer-widget">
        ...
        <?php $__currentLoopData = $content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($loop->index > 2): ?>
                <?php break; ?>
            <?php endif; ?>
            <?php if(data_get(activeTheme(), 'options.footer_style') == 'footer_2'): ?>
...
<?php /**PATH C:\xampp\htdocs\sportsmala\resources\views/site/widgets/footer/editor_picks.blade.php ENDPATH**/ ?>