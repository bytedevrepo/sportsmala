                        ...
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="type" id="type" required>
                                                ...
                                                <option value="{{\Modules\Appearance\Enums\ThemeSectionType::GALLERY}}" {{ $section->type == 4 ? 'selected':'' }}>{{ __('gallery') }}</option>
                                            </select>
                                        </div>
                                    </div>

                                    <div class="col-sm-6 col-md-6 {{ $section->type != 1? 'd-none':'' }}" id="category-area">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6 {{ $section->type == 4 ? '':'d-none' }}" id="gallery-area">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="album_id" id="album_id" required>
                                                ...
                                                @foreach ($albums as $album)
                                                    <option value="{{ $album->id }}" @if($section->album_id == $album->id) selected @endif>{{ $album->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-2 {{ $section->type == 3? 'd-none':'' }}" id="section-style">
                                ...
                                <div class="row">
                                    <div class="col-12 m-t-20">
                                        <div class="form-group form-float form-group-sm text-right">
                                            <button type="submit" name="btnsubmit" class="btn btn-primary pull-right">{{ __('update_section') }}</button>
                                        </div>
                                    </div>
                                </div>
