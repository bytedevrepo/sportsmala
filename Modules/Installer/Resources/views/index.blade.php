...
<html lang="en">
    <head>
        ...
        <title>Sportsmala - Sports News and Magazine Installation</title>
        ...
        <div class="install-box">
            ...
            <div class="panel panel-install">
                <div class="panel-heading text-center">
                    <h2>Sportsmala - Sports News and Magazine Installation</h2>
                </div>
                <div class="panel-body no-padding">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i class="status fa fa-check-circle-o pull-left"> </i><span class="pull-left">Congratulation! You have successfully installed <strong>  Sportsmala - Sports News and Magazine</strong></span>
                                </div>
