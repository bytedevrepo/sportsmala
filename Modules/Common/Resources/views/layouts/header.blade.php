...
<div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            ...
            <a class="navbar-brand" href="{{ route('dashboard') }}"><img src="{{ static_asset(settingHelper('logo')) }}" alt="Logo" class="img-fluid" style="height:45px;" ></a>

            @else

            <a class="navbar-brand" href="{{ route('user-account') }}"><img src="{{ static_asset(settingHelper('logo')) }}" alt="Logo" class="img-fluid" style="height:45px;" ></a>
